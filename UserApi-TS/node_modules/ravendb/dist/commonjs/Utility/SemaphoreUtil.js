...
const PromiseUtil_js_1 = require("./PromiseUtil.js");
...
class SemaphoreAcquisition {
    ...
    constructor(sem, semOpts) {
        ...
        if (semOpts && semOpts.timeout != null) {
            ...
            this._timeout = new PromiseUtil_js_1.AsyncTimeout(semOpts.timeout, timedOutOpName);
        }
        ...
        const semAcquired = new Promise((resolve, reject) => {
            sem.take(() => {
                if (this._disposed || this._isTimedOut()) {
                    ...
                    sem.leave();
                    reject((0, index_js_1.getError)("InvalidOperationException", "Semaphore acquire timed out or was disposed."));
                    return;
                }
                this._acquired = true;
                resolve();
