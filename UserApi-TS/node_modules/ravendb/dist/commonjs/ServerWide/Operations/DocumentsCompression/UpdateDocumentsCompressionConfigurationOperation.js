...
class UpdateDocumentCompressionConfigurationCommand extends RavenCommand_js_1.RavenCommand {
    _documentsCompressionConfiguration;
    constructor(configuration) {
        super();
        if (!configuration) {
