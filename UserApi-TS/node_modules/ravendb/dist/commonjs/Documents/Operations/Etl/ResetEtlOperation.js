...
class ResetEtlOperation {
    ...
    constructor(configurationName, transformationName) {
        if (!configurationName) {
            (0, index_js_1.throwError)("InvalidArgumentException", "ConfigurationName cannot be null");
        }
        if (!transformationName) {
            (0, index_js_1.throwError)("InvalidArgumentException", "TransformationName cannot be null");
        }
...
class ResetEtlCommand extends RavenCommand_js_1.RavenCommand {
    _configurationName;
    _transformationName;
    constructor(configurationName, transformationName) {
        super();
