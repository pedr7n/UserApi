...
class StartTransactionsRecordingOperation {
    ...
    constructor(filePath) {
        if (!filePath) {
            (0, index_js_1.throwError)("InvalidArgumentException", "FilePath cannot be null");
        }
...
class StartTransactionsRecordingCommand extends RavenCommand_js_1.RavenCommand {
    _filePath;
    constructor(filePath) {
        super();
        this._filePath = filePath;
