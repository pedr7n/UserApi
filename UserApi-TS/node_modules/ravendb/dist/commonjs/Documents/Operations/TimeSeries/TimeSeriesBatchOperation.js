...
class TimeSeriesBatchOperation {
    ...
    constructor(documentId, operation) {
        if (!documentId) {
            (0, index_js_1.throwError)("InvalidArgumentException", "Document id cannot be null");
        }
        if (!operation) {
            (0, index_js_1.throwError)("InvalidArgumentException", "Operation cannot be null");
        }
...
class TimeSeriesBatchCommand extends RavenCommand_js_1.RavenCommand {
    _documentId;
    _operation;
    _conventions;
