...
const FacetBuilder_js_1 = require("./FacetBuilder.js");
class AggregationDocumentQuery extends AggregationQueryBase_js_1.AggregationQueryBase {
    _source;
    constructor(source) {
    ...
    andAggregateBy(builderOrFacet) {
        if (typeof builderOrFacet === "function") {
            const f = new FacetBuilder_js_1.FacetBuilder();
            builderOrFacet(f);
