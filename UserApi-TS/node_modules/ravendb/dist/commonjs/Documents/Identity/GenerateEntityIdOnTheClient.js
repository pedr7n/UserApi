...
class GenerateEntityIdOnTheClient {
    ...
    tryGetIdFromInstance(entity, idCallback) {
        ...
        try {
            const docType = TypeUtil_js_1.TypeUtil.findType(entity, this._conventions.knownEntityTypes);
            ...
            (0, index_js_1.throwError)("InvalidOperationException", "Error trying to get ID from instance.");
        }
    }
    async getOrGenerateDocumentId(entity) {
        ...
        if (id && id.startsWith("/")) {
            (0, index_js_1.throwError)("InvalidOperationException", "Cannot use value '" + id + "' as a document id because it begins with a '/'");
        }
        return id;
    }
