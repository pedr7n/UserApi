...
const HiloReturnCommand_js_1 = require("./Commands/HiloReturnCommand.js");
const NextHiloCommand_js_1 = require("./Commands/NextHiloCommand.js");
const HiloRangeValue_js_1 = require("./HiloRangeValue.js");
...
class HiloIdGenerator {
    ...
    constructor(tag, store, dbName, identityPartsSeparator) {
        ...
        this._lastRangeAt = DateUtil_js_1.DateUtil.zeroDate();
        this._range = new HiloRangeValue_js_1.HiloRangeValue(1, 0, null);
    }
    ...
    async getNextId() {
        ...
        while (true) {
            ...
            const maybeNextTask = new Lazy_js_1.Lazy(() => this._getNextRange());
            let changed = false;
    ...
    async _getNextRange() {
        const hiloCmd = new NextHiloCommand_js_1.NextHiloCommand(this._tag, this._lastBatchSize, this._lastRangeAt, this._identityPartsSeparator, this._range.maxId, this._store.conventions);
        ...
        this._range = new HiloRangeValue_js_1.HiloRangeValue(result.low, result.high, result.serverTag);
    }
    returnUnusedRange() {
        const range = this._range;
        const executor = this._store.getRequestExecutor(this._dbName);
        return executor.execute(new HiloReturnCommand_js_1.HiloReturnCommand(this._tag, range.current, range.maxId));
    }
    get range() {
        return this._range;
    }
