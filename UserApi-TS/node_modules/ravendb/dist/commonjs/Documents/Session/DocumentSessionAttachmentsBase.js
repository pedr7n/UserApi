...
const AdvancedSessionExtensionBase_js_1 = require("./AdvancedSessionExtensionBase.js");
const Constants_js_1 = require("./../../Constants.js");
const StringUtil_js_1 = require("../../Utility/StringUtil.js");
const index_js_1 = require("../../Exceptions/index.js");
const IdTypeAndName_js_1 = require("../IdTypeAndName.js");
const PutAttachmentCommandData_js_1 = require("../Commands/Batches/PutAttachmentCommandData.js");
const DeleteAttachmentCommandData_js_1 = require("../Commands/Batches/DeleteAttachmentCommandData.js");
const MoveAttachmentCommandData_js_1 = require("../Commands/Batches/MoveAttachmentCommandData.js");
const CopyAttachmentCommandData_js_1 = require("../Commands/Batches/CopyAttachmentCommandData.js");
const TypeUtil_js_1 = require("../../Utility/TypeUtil.js");
class DocumentSessionAttachmentsBase extends AdvancedSessionExtensionBase_js_1.AdvancedSessionExtensionBase {
    constructor(session) {
        super(session);
    }
    getNames(entity) {
        ...
        if (TypeUtil_js_1.TypeUtil.isString(entity)) {
            (0, index_js_1.throwError)("InvalidArgumentException", "getNames requires a tracked entity object, other types such as documentId are not valid.");
        }
        const document = this._session.documentsByEntity.get(entity);
        if (!document) {
            this._throwEntityNotInSession(entity);
        }
        const results = document.metadata[Constants_js_1.CONSTANTS.Documents.Metadata.ATTACHMENTS];
        return results || [];
    }
    store(documentIdOrEntity, name, stream, contentType = null) {
        ...
        if (StringUtil_js_1.StringUtil.isNullOrWhitespace(documentIdOrEntity)) {
        ...
        if (this._deferredCommandsMap.has(IdTypeAndName_js_1.IdTypeAndName.keyFor(documentIdOrEntity, "DELETE", null))) {
            DocumentSessionAttachmentsBase._throwOtherDeferredCommandException(documentIdOrEntity, name, "store", "delete");
        }
        if (this._deferredCommandsMap.has(IdTypeAndName_js_1.IdTypeAndName.keyFor(documentIdOrEntity, "AttachmentPUT", name))) {
            DocumentSessionAttachmentsBase._throwOtherDeferredCommandException(documentIdOrEntity, name, "store", "create");
        }
        if (this._deferredCommandsMap.has(IdTypeAndName_js_1.IdTypeAndName.keyFor(documentIdOrEntity, "AttachmentDELETE", name))) {
            DocumentSessionAttachmentsBase._throwOtherDeferredCommandException(documentIdOrEntity, name, "store", "delete");
        }
        if (this._deferredCommandsMap.has(IdTypeAndName_js_1.IdTypeAndName.keyFor(documentIdOrEntity, "AttachmentMOVE", name))) {
        ...
        this.defer(new PutAttachmentCommandData_js_1.PutAttachmentCommandData(documentIdOrEntity, name, stream, contentType, null));
    }
    ...
    _moveByEntities(sourceEntity, sourceName, destinationEntity, destinationName) {
        ...
        if (!destinationEntity) {
            (0, index_js_1.throwError)("InvalidArgumentException", "DestinationEntity cannot be null");
        }
    ...
    _moveByEntityIds(sourceDocumentId, sourceName, destinationDocumentId, destinationName) {
        if (StringUtil_js_1.StringUtil.isNullOrWhitespace(sourceDocumentId)) {
            (0, index_js_1.throwError)("InvalidArgumentException", "SourceDocumentId is required.");
        }
        if (StringUtil_js_1.StringUtil.isNullOrWhitespace(sourceName)) {
            (0, index_js_1.throwError)("InvalidArgumentException", "SourceName is required.");
        }
        ...
        if (StringUtil_js_1.StringUtil.equalsIgnoreCase(sourceDocumentId, destinationDocumentId)
        ...
        if (this._deferredCommandsMap.has(IdTypeAndName_js_1.IdTypeAndName.keyFor(sourceDocumentId, "AttachmentDELETE", sourceName))) {
            DocumentSessionAttachmentsBase._throwOtherDeferredCommandException(sourceDocumentId, sourceName, "rename", "delete");
        }
        if (this._deferredCommandsMap.has(IdTypeAndName_js_1.IdTypeAndName.keyFor(sourceDocumentId, "AttachmentMOVE", sourceName))) {
            DocumentSessionAttachmentsBase._throwOtherDeferredCommandException(sourceDocumentId, sourceName, "rename", "rename");
        }
        if (this._deferredCommandsMap.has(IdTypeAndName_js_1.IdTypeAndName.keyFor(destinationDocumentId, "AttachmentDELETE", destinationName))) {
            DocumentSessionAttachmentsBase._throwOtherDeferredCommandException(sourceDocumentId, destinationName, "rename", "delete");
        }
        if (this._deferredCommandsMap.has(IdTypeAndName_js_1.IdTypeAndName.keyFor(destinationDocumentId, "AttachmentMOVE", destinationName))) {
            DocumentSessionAttachmentsBase._throwOtherDeferredCommandException(sourceDocumentId, destinationName, "rename", "rename");
        }
        const cmdData = new MoveAttachmentCommandData_js_1.MoveAttachmentCommandData(sourceDocumentId, sourceName, destinationDocumentId, destinationName, null);
        this.defer(cmdData);
    }
    ...
    _copyByEntityIds(sourceDocumentId, sourceName, destinationDocumentId, destinationName) {
        ...
        const cmdData = new CopyAttachmentCommandData_js_1.CopyAttachmentCommandData(sourceDocumentId, sourceName, destinationDocumentId, destinationName, null);
        this.defer(cmdData);
    }
    static _throwDocumentAlreadyDeleted(documentId, name, operation, destinationDocumentId, deletedDocumentId) {
        (0, index_js_1.throwError)("InvalidOperationException", "Can't " + operation + " attachment '" + name + "' of document '" + documentId + "' " +
    ...
    static _throwOtherDeferredCommandException(documentId, name, operation, previousOperation) {
        (0, index_js_1.throwError)("InvalidOperationException", "Can't " + operation + " attachment '" + name + "' of document '"
