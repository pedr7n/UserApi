...
exports.VectorSearchToken = void 0;
const WhereToken_js_1 = require("./WhereToken.js");
const VectorSearchUtil_js_1 = require("../../../Utility/VectorSearchUtil.js");
class VectorSearchToken extends WhereToken_js_1.WhereToken {
    ...
    writeTo(writer) {
        ...
        if (this._sourceQuantizationType === "Single" && this._targetQuantizationType === "Single") {
            ...
            const methodName = (0, VectorSearchUtil_js_1.vectorSearchConfigurationToMethodName)(this._sourceQuantizationType, this._targetQuantizationType);
...
exports.VectorSearchToken = VectorSearchToken;
