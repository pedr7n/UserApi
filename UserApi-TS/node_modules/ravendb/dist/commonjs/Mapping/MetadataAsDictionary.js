...
exports.MetadataDictionary = exports.MetadataInternal = void 0;
...
exports.MetadataInternal = MetadataInternal;
...
function createMetadataDictionary(metadataParams) {
    ...
    if (parentInfo) {
        if (!parentInfo.parent) {
            return (0, index_js_1.throwError)("InvalidArgumentException", "Parent cannot be null");
        }
        if (!parentInfo.parentKey) {
            return (0, index_js_1.throwError)("InvalidArgumentException", "Parent key cannot be null");
        }
...
//# sourceMappingURL=MetadataAsDictionary.js.map