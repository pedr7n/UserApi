export class FilterFactory {
    _documentQuery;
    constructor(documentQuery, filterLimit = Number.MAX_SAFE_INTEGER) {
        this._documentQuery = documentQuery;
        this._setFilterLimit(filterLimit);
    }
    equals(fieldNameOrWhereParams, value, exact = false) {
        this._documentQuery._whereEquals(fieldNameOrWhereParams, value, exact);
        return this;
    }
    notEquals(fieldNameOrWhereParams, value, exact = false) {
        this._documentQuery._whereNotEquals(fieldNameOrWhereParams, value, exact);
        return this;
    }
    ...
    _setFilterLimit(limit) {
        this._documentQuery._addFilterLimit(limit);
    }
}
