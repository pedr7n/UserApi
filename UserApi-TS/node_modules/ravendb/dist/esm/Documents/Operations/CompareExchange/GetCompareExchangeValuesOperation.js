...
export class GetCompareExchangeValuesOperation {
    _clazz;
    _keys;
    _startWith;
    _start;
...
export class GetCompareExchangeValuesCommand extends RavenCommand {
    _operation;
    _materializeMetadata;
    _conventions;
    ...
    async setResponseAsync(bodyStream, fromCache) {
        ...
        this.result = CompareExchangeValueResultParser.getValues(localObject, this._materializeMetadata, this._conventions, this._operation.clazz);
        return body;
    }
