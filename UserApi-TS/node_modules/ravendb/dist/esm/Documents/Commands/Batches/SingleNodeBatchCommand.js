...
export class SingleNodeBatchCommand extends RavenCommand {
    ...
    async setResponseAsync(bodyStream, fromCache) {
        if (!bodyStream) {
            throwError("InvalidOperationException", "Got null response from the server after doing a batch,"
                + " something is very wrong. Probably a garbled response.");
        }
        let body = null;
        this.result = await RavenCommandResponsePipeline.create()
